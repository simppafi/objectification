...
namespace simppafi
{
	public class VisualDoorsObj : simppafi.BaseVisual
	{
		private Batch				Geom;
		private Batch				Geom2;
		...
		override public void Setup()
		{
			...
			modelData = FetchModelData(		import Model("../Assets/models/human_parts3.fbx"), 
											modelData, 
											float3(0f,0f,0f), 
		...
		private ModelData FetchModelData(Model model, ModelData modelData, float3 pos, float3 rot, float3 sca, bool gotUV = true, float3 color = float3(1f))
		{
			...
			debug_log "VisualDoorsObj DRAWABLE COUNT "+model.DrawableCount;
		...
		private int BatchModel(Batch Geom, int indexAdd, ModelData modelData)
		{
			...
			debug_log "VisualDoorsObj "+modelData.vertexCount;
