...
namespace simppafi
{
	public class VisualRoomStaticTunnel : simppafi.BaseVisual
	{
		private Batch				Geom;
		private Random 				rand = new Random(1);

		public VisualRoomStaticTunnel()
		{
		...
		override public void Setup()
		{
			...
			///*
			var geometric = simppafi.Geometry.VerticeGenerator.CreateCubeSphereHalf(16, false);//CreateCube();
			...
			debug_log "Static VisualRoomStaticTunnel Vertices "+verticeCount;
			...
			for(i = 0; i < geometric.vertices.Count; i++)
			{
				...
				av = v * float3(-150f,-150f,-150f);//float3(-250f, -180f, -250f);
