...
namespace simppafi
{
	public class VisualBodyGrill1LO : simppafi.BaseVisual
	{
		...
		private void AddParticleGroup(int count = 0)
		{
			...
			debug_log "VisualBodyGrill1LO Vertices "+verticeCount+" cubeCount "+cubeCount;
