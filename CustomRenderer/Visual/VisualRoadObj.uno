...
namespace simppafi
{
	public class VisualRoadObj : simppafi.BaseVisual
	{
		private Batch				Geom;
		private Batch				Geom2;
		...
		override public void Setup()
		{
			...
			*/
			...
			var modelData2 = new ModelData();
			modelData2 = FetchModelData(	simppafi.Models.people5, 
											modelData2, 
											float3(_pos[0].X + 12f,0f, _pos[0].Y), 
			...
			modelData2 = FetchModelData(	simppafi.Models.people2, 
											modelData2, 
											float3(_pos[1].X + 12f,0f, _pos[1].Y), 
											float3(0,Math.PIf * 2f * rand.NextFloat(),0),
											float3(14f), 
											false,
											float3(1,1,1)//simppafi.Color.ColorHexToRGB.HexToRGB(0xd9d893)//0x56f1ff););
			...
			modelData2 = FetchModelData(	simppafi.Models.people3, 
											modelData2, 
											float3(_pos[2].X + 12f,0f, _pos[2].Y), 
											float3(0,Math.PIf * 2f * rand.NextFloat(),0),
											float3(16f), 
											false,
											float3(1,1,1)//simppafi.Color.ColorHexToRGB.HexToRGB(0xd9d893)//0x56f1ff););
			...
			modelData2 = FetchModelData(	simppafi.Models.people4, 
											modelData2, 
											float3(_pos[3].X - 12f,0f, _pos[3].Y), 
											float3(0,Math.PIf * 2f * rand.NextFloat(),0),
											float3(18f), 
											false,
											float3(1,1,1)//simppafi.Color.ColorHexToRGB.HexToRGB(0xd9d893)//0x56f1ff););
			...
			modelData2 = FetchModelData(	simppafi.Models.people7, 
											modelData2, 
											float3(_pos[4].X - 12f,0f, _pos[4].Y),  
											float3(0,Math.PIf * 2f * rand.NextFloat(),0),
											float3(15f), 
											false,
											float3(1,1,1)//simppafi.Color.ColorHexToRGB.HexToRGB(0xd9d893)//0x56f1ff););
