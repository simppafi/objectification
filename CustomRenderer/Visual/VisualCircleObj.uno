...
namespace simppafi
{
	public class VisualCircleObj : simppafi.BaseVisual
	{
		private Batch				Geom;
		private Batch				Geom2;
		...
		override public void Setup()
		{
			...
			modelData = FetchModelData(		import Model("../Assets/models/fist.fbx"), 
											modelData, 
											float3(5f,0,-10f), 
		...
		private ModelData FetchModelData(Model model, ModelData modelData, float3 pos, float3 rot, float3 sca, bool gotUV = true, float3 color = float3(1f))
		{
			...
			debug_log "VisualCircleObj DRAWABLE COUNT "+model.DrawableCount;
		...
		private int BatchModel(Batch Geom, int indexAdd, ModelData modelData)
		{
			...
			debug_log "VisualCircleObj "+modelData.vertexCount;
