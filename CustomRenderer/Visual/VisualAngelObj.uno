...
namespace simppafi
{
	public class VisualAngelObj : simppafi.BaseVisual
	{
		private Batch				Geom;
		private Batch				Geom2;
		...
		override public void Setup()
		{
			...
			*/
			/*
			modelData = FetchModelData(		simppafi.Models.people1, 
											modelData, 
											float3(-100f,2.25f,0f), 
...
/*
			...
			modelData2 = FetchModelData(	import Model("../Assets/models/angel.fbx"), 
											modelData2, 
											float3(0,0f,60f), 
...
*/
			/*
			modelData2 = FetchModelData(	import Model("../Assets/models/new_hand_low.fbx"), 
											modelData2, 
											float3(0,0,-25), 
											float3(-Math.PIf*.5f,0f,0), //Math.PIf * 2f * rand.NextFloat()
											float3(40f,40f,40f), 
...
/*
		private ModelData FetchModelData(Model model, ModelData modelData, float3 pos, float3 rot, float3 sca, bool gotUV = true, float3 color = float3(1f))
		{
			...
			debug_log "VisualHandsObj DRAWABLE COUNT "+model.DrawableCount;
...
*/
  ...
  /*  		
    		draw this, Geom2, ShaderDude, simppafi.ShaderMaterial.Aluminum, MyMaterial, virtual simppafi.RenderPipeline.PassFront;
    */		
		}
