...
namespace simppafi
{
	public class VisualBoxesLO : simppafi.BaseVisual
	{
		...
		private void AddParticleGroup(int count = 0)
		{
			...
			var _pos = new [] {	float3(-45f,0f,0f-40f),
								float3(15f,30f,0f-40f), 
								float3(-20f,30f,10f-40f), 
								float3(0f,0f,0f-40f), 
								float3(60f,2f,0f-40f) 
							};
		...
		override public void OnUpdate()
		{
			...
			for(var i = 0; i < l; i++)
			{
				...
				simppafi.RenderPipeline.Lights[i].Scale = 20f + Math.Min(20f, 20f * _PowerGoto[i]);
