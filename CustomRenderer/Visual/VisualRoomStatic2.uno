...
namespace simppafi
{
	public class VisualRoomStatic2 : simppafi.BaseVisual
	{
		private Batch				Geom;
		private Random 				rand = new Random(1);

		public VisualRoomStatic2()
		{
		...
		override public void Setup()
		{
			...
			///*
			var geometric = simppafi.Geometry.VerticeGenerator.CreateCubeSphereHalf(32, false);//CreateCube();
			...
			debug_log "Static Room 2 Vertices "+verticeCount;
			...
			for(i = 0; i < geometric.vertices.Count; i++)
			{
				...
				av = v * float3(-175f,-150f,-175f);//float3(-250f, -180f, -250f);
